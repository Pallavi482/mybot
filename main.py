...
BOT_TOKEN = "8686847961:AAGdiPHVtcWuD69t312TuLVCiW2nJcWPfEU"
...
# ================= 📩 SCREENSHOT & TEXT FORWARDING TO ADMIN (PRIVATE CHAT ONLY FIX) =================
...
# Handle User Text Messages (PRIVATE CHAT ONLY FIX)
@bot.message_handler(func=lambda message: message.chat.id not in ADMIN_LIST and not message.text.startswith('/') and message.chat.type == 'private')
